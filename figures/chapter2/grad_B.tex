...
\draw[ {latex}- ] (\xinter- \vectorlength/2*\derive,  \yinter-\vectorlength/2*\derive) --  (\xinter+0.25, \yinter+0.05) node[anchor=west, align=left] {\tiny Force \( e_j \mathbf{v} \times \mathbf{B} \)};
