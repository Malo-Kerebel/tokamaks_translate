...
\begin{document}
	...
	\draw[{Stealth}-] (0, -\R-\Shift+\Shift/\n+2*\R/\n+\elong/2) -- (0, -2.1) node[below=-3pt, align=center] {\small\shortstack{enroulement primaire}};
	
	\draw[{Stealth}-] (0, 1.5*\R) -- (1, 2.5) node[above=-3pt, align=center] {\small\shortstack{Noyau en fer}};
