...
\begin{document}
	...
	\begin{tikzpicture}
    	...
    	\node[above=-3pt, align=center] at (-1.9, 1.9) {\tiny\shortstack{courant\\ primaire}};
    		
    	% Légende de la figure
    	
    	\draw[{Stealth}-] (0,1.025) -- (-0.66,1.5) node[above=-3pt] {\tiny\shortstack{Chambre\\ à vide}};
    	
    	\draw[{Stealth}-] (1.375,1.375) -- (1.1,2) node[left=-3pt, align=center] {\tiny\shortstack{Bobine de\\ controle de\\ position}};
