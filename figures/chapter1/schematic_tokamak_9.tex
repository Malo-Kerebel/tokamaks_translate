...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\draw[pattern=north west lines, pattern color=gray]
			(-\sizex, 1.5*\sizey) -- (-\sizex-\sizex/4, 1.5*\sizey) -- (-\sizex-\sizex/4, -1.5*\sizey) -- (-\sizex, -1.5*\sizey) -- cycle;
			\node[anchor=east, align=center] at (-\sizex-\sizex/4, 0)  {\tiny\shortstack{Bobine\\ primaire}};
		...
		\node[anchor=west, align=center] at (2.5, 3)  {\tiny\shortstack{Bobines\\ de champ\\ poloïdal}};
			
		\draw[{Stealth}-] (0,-2.5) -- (1, -3.5) node[below right=-3pt, align=center] {\tiny\shortstack{Bouclier}};
		
		\draw[{Stealth}-] (2.25,0) -- (2.75, 0) node[right=-3pt, align=center] {\tiny\shortstack{Bobine\\ de champ\\ toroïdal}};
		
		\draw[{Stealth}-] (1,-1) -- (2.25, -1.75) node[right=-3pt, align=center] {\tiny\shortstack{Couverture}};
