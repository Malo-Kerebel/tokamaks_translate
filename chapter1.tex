...
\begin{figure}
    ...
    \begin{minipage}[c]{0.55\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter1/power_comp_tau_E.pdf}
    \end{minipage}
\end{figure}
...
\begin{wrapfigure}{r}{0.3\textwidth}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter1/schematic_tokamak_1.pdf}
        \label{subfig:schematic_tokamak_1}
    \end{subfigure}
    
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{{figures/chapter1/schematic_tokamak_2.pdf}}
...
Le champ magnétique toroïdal est produit par les courants dans les bobines liant le plasma
