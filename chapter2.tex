...
\end{align}
Dans l'\autoref{eq:changement_qdm}, la longueur de Debye, \( \lambda_D \), a été introduite comme limite supérieure pour retirer la divergence provoquée après avoir néglig" l'écrantage de Debye pour les collisions avec un paramètre d'impact supérieur à la longueur de Debye.
...
Dans l'\autoref{eq:vlasov_gyromoyenne} les deux premiers termes du côté gauche de l'équation contiennent la dérivée temporelle Lagrangienne convectée le long de la tajectoire du centre guide.
Le coefficient de \( \left( \partial \overline{f}/\partial K  \right) \) contient le travail fait par le gchamp électrique sur le centre guide avec le changement de l'énergie perpendiculaire, \( \frac{1}{2} m v_\perp^2 \), subit par le centre guide (dont le moment magnétique \( \mu \) est conservé) dans un champs magnétique changeant.
...
L'équation est utilisé dans des études linéaires et non-linéaire d'instabilités à basse fréqeunce et à grande longueur d'onde, et dans la théorie transport néoclassique où le fait de négliger la contribution "classique" au transport, venant des orbites de Larmor, n'est pas important.
