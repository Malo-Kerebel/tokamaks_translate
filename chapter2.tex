...
L'inclusion des collisions nécessite l'addition d'un terme \( \left( \partial f / \partial t \right)_c \) dans le côté droit de l'\autoref{eq:vlasov}.
...
Il est donc pratique d'utiliser les coordonnées Cartésiennes parallèles et perpendiculaires à une direction choisié comme montré dans la figure
