...
\[
	f_1 \left( \bm{v}_i \right) = \frac{n_1}{\left(2 \pi \right)^{3/2} v^3_{T1}} \exp{-\left( \frac{v^2_1}{2v^2_{T1}} \right)}
\]
...
\[
	H_1 = \left(1+\frac{m}{m_1} \right) n_1 \frac{\Phi \left(v/\sqrt{2} v_{T1}\right)}{v}
\]

\noindent et

\[
	G_1 = n_1 \left( \frac{v^2 + v^2_{T1}}{v} \Phi \left(v/\sqrt{2} v_{T1} \right) + \frac{v_{T1}}{\sqrt{2}} v_{T1} \Phi' \left(v/\sqrt{2} v_{T1} \right) \right)
\]
...
\begin{align*}
	\left\langle \Delta v_\parallel \right\rangle &= - A_D \left(1 + \frac{m}{m_1} \right) \frac{\Psi \left( v / \sqrt{2} v_{T_1}\right)}{2v_{T_1}}²\\
...
\begin{equation}
	\left\langle \left( \Delta v_{\perp} \right)^2 \right\rangle = A_D \frac{\Phi \left( v / \sqrt{2} v_{T1} \right) - \Psi \left( v / \sqrt{2} v_{T1} \right)}{v}
...
\[
	\left\langle \left( \Delta v \right)^2 \right\rangle = \left\langle \left( \Delta v_\parallel \right)^2 \right\rangle + \left\langle \left( \Delta v_{\perp} \right)^2 \right\rangle = A_D \frac{\Phi \left( v / \sqrt{2}v_{T1}\right)}{v}.
\]
